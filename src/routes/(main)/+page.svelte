...
<div class="mb-8 mt-8 flex flex-col-reverse justify-between gap-4 md:mb-24 md:flex-row md:items-center">
    ...
    <div class="relative md:ml-16 w-full md:w-[55%] lg:w-[50%] xl:w-[45%]">
        ...
        <h2 class="mb-4 px-8 text-3xl font-Medium text-secondary-foreground md:px-0">
...
<div class="mx-4 mb-16 md:mx-0 md:mb-32">
    ...
    <div class="mx-auto grid max-w-4xl grid-cols-1  gap-6 md:grid-cols-2 lg:gap-10 relative">
        ...
        <div class="flex w-full flex-col items-center justify-center rounded-xl bg-white p-8 drop-shadow-lg transition-transform hover:scale-[1.02]">
            ...
            <p class="text-center leading-relaxed text-primary-foreground md:text-xl">
                ได้รับประกาศนียบัตรรับรอง <br/> การเข้าร่วมโครงการ 
            </p>
        </div>
        ...
        <div class="flex w-full flex-col items-center justify-center rounded-xl bg-white p-8 drop-shadow-lg transition-transform hover:scale-[1.02]">
            ...
            <p class="text-center leading-relaxed text-primary-foreground md:text-xl">
                ปูพื้นฐานตั้งแต่เริ่มต้น <br/> ไปจนถึงการเทรนโมเดลจริง
            </p>
        </div>
...
<div class="mx-4 mb-16 md:mx-0 md:mb-32 relative">
    ...
    <div class="mb-4 flex flex-col md:mb-2 md:flex-row md:items-start">
        ...
        <div class="mb-1 flex flex-wrap items-center text-primary-foreground md:mb-0 md:flex-nowrap">
            ...
            {#if agenda[2] !== null}
                <span class="mx-2 block w-auto text-center md:w-4 md:text-lg">
                    -
                </span>
                <span class="block w-auto font-medium md:mr-16 md:w-28 md:font-normal md:text-lg">
        ...
        <span class="block w-full flex-grow break-words leading-relaxed text-accent md:w-0 md:text-lg">
            {agenda[3]}
        </span>
...
<div class="mx-4 mb-16  md:mx-8 md:mb-32">
    ...
    <div class="mx-auto flex w-full max-w-7xl flex-col relative items-center relative justify-center gap-10 md:flex-row md:items-stretch lg:gap-24 xl:gap-[100px]">
        ...
        <div class="flex w-full flex-col justify-center space-y-8 md:w-1/2">
            {#each requirements as requirement, i (requirement)}
                <div class="flex items-start gap-4 md:items-center">
                    ...
                    <span class="text-lg leading-relaxed text-primary-foreground md:text-xl">{requirement}</span>
                </div>
            {/each}
        </div>
    </div>
        ...
        <div class="flex items-center justify-center gap-4">
            {#if isRoleAtLeast(data.user?.role, roles.teacher)}
                <Dialog.Root bind:open={isCreateAnnouncementFormDialogOpen}>
                    <Dialog.Trigger
                        class="flex h-12 w-12 items-center justify-center rounded-full bg-secondary-foreground text-white transition-colors hover:bg-primary-foreground drop-shadow-md">
                        <Plus size={28} />
                    </Dialog.Trigger>
                    <Dialog.Content>
                        <Dialog.Header>
    ...
    <div class="space-y-4 md:mx-16 ">
        {#each data.announcements as announcement (announcement.id)}
            <a
                ...
                class="mx-auto flex max-w-7xl items-center gap-4 rounded-xl bg-white p-4 drop-shadow-lg transition-transform hover:scale-[1.01] box-shadow: 4px 4px 30px 0 rgba(131, 190, 255, 0.60);">
                ...
                <a
                    ...
                    <div class="flex flex-shrink-0 items-center justify-center rounded-full text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" fill="none">
                            <path d="M48 24.0602C48 10.7789 37.248 0 24 0C10.752 0 0 10.7789 0 24.0602C0 35.7053 8.256 45.4015 19.2 47.6391V31.2782H14.4V24.0602H19.2V18.0451C19.2 13.4015 22.968 9.62406 27.6 9.62406H33.6V16.8421H28.8C27.48 16.8421 26.4 17.9248 26.4 19.2481V24.0602H33.6V31.2782H26.4V48C38.52 46.797 48 36.5474 48 24.0602Z" fill="url(#paint0_linear_1313_18105)"/>
                            <defs>
                                <linearGradient id="paint0_linear_1313_18105" x1="-0.000747503" y1="47.9997" x2="47.9994" y2="-0.000584423" gradientUnits="userSpaceOnUse">
